...
def resnet50_block(input_feature_map, number_bottleneck_channels,
    ...
    """ Run a ResNet Block """
    W_conv1_res = weight_variable([1, 1, number_input_channels, number_bottleneck_channels], 'bottleneck_weights')
    b_conv1_res = bias_variable([number_bottleneck_channels], 'bottleneck_bias')
    ...
    W_conv2_res = weight_variable([3, 3, number_bottleneck_channels, number_bottleneck_channels], 'conv2d_3x3_weights')
    b_conv2_res = bias_variable([number_bottleneck_channels], 'conv2d_3x3_bias')
    ...
    # Perform a ResNet Block
    W_conv3_res = weight_variable([1, 1, number_bottleneck_channels, number_output_channels], 'bottleneck_weights_up')
    b_conv3_res = bias_variable([number_output_channels], 'bottleneck_bias_up')
    ...
    project_weights = weight_variable([1, 1, number_input_channels, number_output_channels], 'projection_weights')
    project_bias = bias_variable([number_output_channels], 'projection_bias')
